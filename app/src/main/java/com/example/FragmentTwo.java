...
public class FragmentTwo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FragmentThree fr3 = (FragmentThree) fr;
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                getParentFragmentManager().beginTransaction()
                        .replace(R.id.fragmentContainerView, fr3, null)
                        //.setCustomAnimations(R.anim.enterAnimation, R.anim.exitAnimation, R.anim.fr3.getEnterAnimation(), R.anim.fr3.getExitAnimation());
 ...
 */
    private Fragment getFragmentFromJSON(String pathname) {
        ...
        //FragmentThree fr3 = gson.fromJson(reader, FragmentThree.class);
